...
# Script de Migración a Next.js 15 + Tailwind CSS
# Réplicas Cuauhtémoc

echo "🚀 Iniciando migración a Next.js 15 + Tailwind CSS..."
echo ""
...
echo -e "${BLUE}📥 Paso 4/5: Instalando dependencias de Next.js...${NC}"
...
echo ""
echo -e "${GREEN}✨ ¡Éxito! Tu proyecto ahora usa Next.js 15 + Tailwind CSS${NC}"
